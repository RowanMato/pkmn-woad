...
wMoveBuffer::
wRelearnableMoves::
	ds 164; Try not to use this stack.
; A good amount of space is needed to store data for the move reminder.
...
wNextEncounterLevel:: db ; d3aa
wNextEncounterSpecies:: db ; d3ab
