...
ENDC
IF DEF(_RED)
	RGB 31,29,31, 30,30,17, 18,18,24, 07,07,16 ; PAL_LOGO2 TODO Split this 3 ways like in CGB pals
ENDC
IF DEF(_BLUE)
	RGB 31,29,31, 30,30,17, 18,18,24, 07,07,16 ; PAL_LOGO2 TODO Split this 3 ways like in CGB pals
ENDC
...
ENDC
	...
	RGB 31,29,31, 10,28,17, 07,08,13, 03,02,02 ; PAL_SHINYMEWMON			custom weird green/blue
	RGB 31,29,31, 30,22,24, 28,15,21, 03,02,02 ; PAL_SHINYBLUEMON			pink
	RGB 31,29,31, 27,22,24, 21,15,23, 03,02,02 ; PAL_SHINYREDMON 			purple
	RGB 31,29,31, 20,26,16, 09,20,11, 03,02,02 ; PAL_SHINYCYANMON			green
	RGB 31,29,31, 31,20,10, 26,10,06, 03,02,02 ; PAL_SHINYPURPLEMON		red
	RGB 31,29,31, 26,21,22, 15,15,18, 03,02,02 ; PAL_SHINYBROWNMON		gray
	RGB 31,29,31, 31,28,14, 26,20,00, 03,02,02 ; PAL_SHINYGREENMON 		yellow
	RGB 31,29,31, 21,25,29, 14,19,25, 03,02,02 ; PAL_SHINYPINKMON			cyan
	RGB 31,29,31, 18,20,27, 11,15,23, 03,02,02 ; PAL_SHINYYELLOWMON		blue
	RGB 31,29,31, 28,20,15, 21,14,09, 03,02,02 ; PAL_SHINYGREYMON			brown
