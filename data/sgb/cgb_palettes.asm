...
IF DEF(_RED)
	RGB 31,31,31, 00,00,00, 00,00,00, 03,23,03 ; PAL_LOGO1 WoAd (RED VERSION)
ENDC
IF DEF(_BLUE)
	RGB 31,31,31, 00,00,00, 00,00,00, 23,03,03 ; PAL_LOGO1 WoAd (BLUE VERSION)
ENDC
IF DEF(_GREEN)
	RGB 31,31,31, 00,00,00, 00,00,00, 03,03,23 ; PAL_LOGO1 WoAd (GREEN VERSION)
ENDC
IF DEF(_RED)
	RGB 31,31,31, 31,31,00, 23,03,03, 03,03,23 ; PAL_LOGO2 PKMN (RED VERSION)
ENDC
IF DEF(_BLUE)
	RGB 31,31,31, 31,31,00, 03,03,23, 03,23,03 ; PAL_LOGO2 PKMN (BLUE VERSION)
ENDC
IF DEF(_GREEN)
	RGB 31,31,31, 31,31,00, 03,23,03, 23,03,03 ; PAL_LOGO2 PKMN (GREEN VERSION)
ENDC
...
ENDC
	...
	RGB 31,31,31, 10,28,17, 07,08,13, 03,03,03 ; PAL_SHINYMEWMON			custom weird green/blue
	RGB 31,31,31, 31,15,18, 31,00,06, 03,03,03 ; PAL_SHINYBLUEMON			pink
	RGB 31,31,31, 25,15,31, 19,00,22, 03,03,03 ; PAL_SHINYREDMON 			purple
	RGB 31,31,31, 17,31,11, 01,22,06, 03,03,03 ; PAL_SHINYCYANMON			green
	RGB 31,31,31, 31,17,00, 31,00,00, 03,03,03 ; PAL_SHINYPURPLEMON		red
	RGB 31,31,31, 25,22,23, 11,11,14, 03,03,03 ; PAL_SHINYBROWNMON		gray
	RGB 31,31,31, 31,31,00, 28,14,00, 03,03,03 ; PAL_SHINYGREENMON 		yellow
	RGB 31,31,31, 16,26,31, 00,17,31, 03,03,03 ; PAL_SHINYPINKMON			cyan
	RGB 31,31,31, 16,18,31, 00,01,25, 03,03,03 ; PAL_SHINYYELLOWMON		blue
	RGB 31,31,31, 29,18,10, 17,09,05, 03,03,03 ; PAL_SHINYGREYMON			brown
