...
; PKMN:WoAd Team
	...
	db $FF, 88, PORYGON, 87, KINGLER, 87, PINSIR, 88, TAUROS, 89, BLASTOISE, 90, MEW, 0
; Unused Vanilla Team
...
; Rematch
	db $FF, 75, PRIMEAPE, 75, HITMONCHAN, 75, HITMONLEE, 75, POLIWRATH, 75, MACHAMP, 0

BrockData:
	db $FF, 12, GEODUDE, 14, ONIX, 0
; Rematch
	db $FF, 65, ONIX, 65, OMASTAR, 65, GOLEM, 65, KABUTOPS, 70, AERODACTYL, 0

MistyData:
	db $FF, 14, PSYDUCK, 18, STARYU, 21, STARMIE, 0
; Rematch
	db $FF, 65, GOLDUCK, 65, VAPOREON, 65, SEADRA, 65, BLASTOISE, 70, STARMIE, 0

LtSurgeData:
	db $FF, 21, VOLTORB, 18, PIKACHU, 24, RAICHU, 0
; Rematch
	db $FF, 65, ELECTRODE, 65, MAGNETON, 65, JOLTEON, 65, RAICHU, 70, ELECTABUZZ, 0

ErikaData:
	db $FF, 29, VICTREEBEL, 24, TANGELA, 29, VILEPLUME, 0
; Rematch
	db $FF, 65, VILEPLUME, 65, TANGELA, 65, WIGGLYTUFF, 65, VICTREEBEL, 70, VENUSAUR, 0

KogaData:
	db $FF, 37, KOFFING, 39, MUK, 37, VENOMOTH, 43, WEEZING, 0 ; replaced 2nd Koffing
; Rematch
	db $FF, 65, GOLBAT, 65, MUK, 65, VENOMOTH, 65, WEEZING, 70, SCYTHER, 0

BlaineData:
	db $FF, 42, NINETALES, 40, PONYTA, 42, RAPIDASH, 47, ARCANINE, 0 ; replaced Growlithe
; Rematch
	db $FF, 70, NINETALES, 70, ARCANINE, 70, RAPIDASH, 70, FLAREON, 70, MAGMAR, 0

SabrinaData:
	db $FF, 38, KADABRA, 37, MR_MIME, 38, HYPNO, 43, ALAKAZAM, 0 ; replaced Venomoth
; Rematch
	db $FF, 70, CLEFABLE, 70, HYPNO, 70, MR_MIME, 70, GENGAR, 70, ALAKAZAM, 0
...
; Pokémon Tower 2F
	db $FF, 25, PIDGEOTTO, 23, EXEGGCUTE, 22, KADABRA, 25, WARTORTLE,  20, EEVEE, 0
	db $FF, 25, PIDGEOTTO, 23, GROWLITHE, 22, KADABRA, 25, IVYSAUR,    20, EEVEE, 0
	db $FF, 25, PIDGEOTTO, 23, GYARADOS,  22, KADABRA, 25, CHARMELEON, 20, EEVEE, 0
; Silph Co. 7F
	db $FF, 37, PIDGEOT, 35, EXEGGCUTE, 35, ALAKAZAM, 38, FLAREON,  40, BLASTOISE, 0
	db $FF, 37, PIDGEOT, 35, GROWLITHE, 35, ALAKAZAM, 38, VAPOREON, 40, VENUSAUR, 0
	db $FF, 37, PIDGEOT, 35, GYARADOS,  35, ALAKAZAM, 38, JOLTEON,  40, CHARIZARD, 0
; Route 22
	db $FF, 47, PIDGEOT, 45, RHYHORN, 47, EXEGGCUTE, 45, FLAREON,  50, ALAKAZAM, 53, BLASTOISE, 0
	db $FF, 47, PIDGEOT, 45, RHYHORN, 47, GROWLITHE, 45, VAPOREON, 50, ALAKAZAM, 53, VENUSAUR, 0
	db $FF, 47, PIDGEOT, 45, RHYHORN, 47, GYARADOS,  45, JOLTEON,  50, ALAKAZAM, 53, CHARIZARD, 0

Rival3Data:
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, EXEGGUTOR, 63, FLAREON,  65, BLASTOISE, 0
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, ARCANINE,  63, VAPOREON, 65, VENUSAUR, 0
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, GYARADOS,  63, JOLTEON,  65, CHARIZARD, 0
; Rematch
	db $FF, 85, PIDGEOT, 85, ALAKAZAM, 85, RHYDON, 85, EXEGGUTOR, 85, FLAREON,  85, BLASTOISE, 0
	db $FF, 85, PIDGEOT, 85, ALAKAZAM, 85, RHYDON, 85, ARCANINE,  85, VAPOREON, 85, VENUSAUR, 0
	db $FF, 85, PIDGEOT, 85, ALAKAZAM, 85, RHYDON, 85, GYARADOS,  85, JOLTEON,  85, CHARIZARD, 0

LoreleiData:
	db $FF, 54, DEWGONG, 53, CLOYSTER, 54, SLOWBRO, 56, JYNX, 56, LAPRAS, 0
; Rematch
	db $FF, 75, DEWGONG, 75, CLOYSTER, 75, JYNX, 75, SLOWBRO, 75, LAPRAS, 0
...
; Rematch
	db $FF, 75, ARBOK, 75, HAUNTER, 75, NIDOQUEEN, 75, LICKITUNG, 75, GENGAR, 0

LanceData:
	db $FF, 58, GYARADOS, 56, DRAGONAIR, 56, DRAGONAIR, 60, AERODACTYL, 62, DRAGONITE, 0
; Rematch
	db $FF, 80, DRAGONAIR, 80, GYARADOS, 80, AERODACTYL, 80, CHARIZARD, 80, DRAGONITE, 0
