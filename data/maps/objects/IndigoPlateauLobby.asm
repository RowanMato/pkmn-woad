	...
	const_export INDIGOPLATEAULOBBY_MOVE_REMINDER
	const_export INDIGOPLATEAULOBBY_MOVE_DELETER
...
IndigoPlateauLobby_Object:
	...
	object_event 10,  5, SPRITE_BIKE_SHOP_CLERK, STAY, DOWN, INDIGOPLATEAULOBBY_MOVE_REMINDER
	object_event 11,  5, SPRITE_BALDING_GUY, STAY, DOWN, INDIGOPLATEAULOBBY_MOVE_DELETER
