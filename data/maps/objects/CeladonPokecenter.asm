	...
	const_export CELADONPOKECENTER_MOVE_REMINDER
	const_export CELADONPOKECENTER_MOVE_DELETER
...
CeladonPokecenter_Object:
	...
	object_event  6,  1, SPRITE_BIKE_SHOP_CLERK, STAY, DOWN, CELADONPOKECENTER_MOVE_REMINDER
	object_event  7,  1, SPRITE_BALDING_GUY, STAY, DOWN, CELADONPOKECENTER_MOVE_DELETER
