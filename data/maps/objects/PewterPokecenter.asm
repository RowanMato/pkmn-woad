	...
	const_export PEWTERPOKECENTER_MOVE_REMINDER
	const_export PEWTERPOKECENTER_MOVE_DELETER
...
PewterPokecenter_Object:
	...
	object_event  6,  1, SPRITE_BIKE_SHOP_CLERK, STAY, DOWN, PEWTERPOKECENTER_MOVE_REMINDER
	object_event  7,  1, SPRITE_BALDING_GUY, STAY, DOWN, PEWTERPOKECENTER_MOVE_DELETER
