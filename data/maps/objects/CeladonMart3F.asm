	object_const_def
	const_export CELADONMART3F_CLERK1A
	const_export CELADONMART3F_CLERK1B
	const_export CELADONMART3F_CLERK2
...
CeladonMart3F_Object:
	...
	def_object_events
	object_event 16,  5, SPRITE_CLERK, STAY, NONE, TEXT_CELADONMART3F_CLERK; gives Counter
	object_event 16,  5, SPRITE_CLERK, STAY, UP, TEXT_CELADONMART3F_CLERK_GOOD_TMS; post-game TMs
	object_event 14,  5, SPRITE_CLERK, STAY, UP, TEXT_CELADONMART3F_CLERK_BAD_TMS; early TMs
