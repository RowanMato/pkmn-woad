	...
	const_export CERULEANPOKECENTER_MOVE_REMINDER
	const_export CERULEANPOKECENTER_MOVE_DELETER
...
CeruleanPokecenter_Object:
	...
	object_event  6,  1, SPRITE_BIKE_SHOP_CLERK, STAY, DOWN, CERULEANPOKECENTER_MOVE_REMINDER
	object_event  7,  1, SPRITE_BALDING_GUY, STAY, DOWN, CERULEANPOKECENTER_MOVE_DELETER
