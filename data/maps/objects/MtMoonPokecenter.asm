	...
	const_export MTMOONPOKECENTER_MOVE_REMINDER
	const_export MTMOONPOKECENTER_MOVE_DELETER
...
MtMoonPokecenter_Object:
	...
	object_event  8,  3, SPRITE_GENTLEMAN, STAY, UP, TEXT_MTMOONPOKECENTER_GENTLEMAN
	object_event 10,  6, SPRITE_MIDDLE_AGED_MAN, WALK, LEFT_RIGHT, TEXT_MTMOONPOKECENTER_MAGIKARP_SALESMAN
	object_event  8,  2, SPRITE_CLIPBOARD, STAY, NONE, TEXT_MTMOONPOKECENTER_CLIPBOARD
	object_event 11,  2, SPRITE_LINK_RECEPTIONIST, STAY, DOWN, TEXT_MTMOONPOKECENTER_LINK_RECEPTIONIST
	object_event  6,  1, SPRITE_BIKE_SHOP_CLERK, STAY, DOWN, MTMOONPOKECENTER_MOVE_REMINDER
	object_event  7,  1, SPRITE_BALDING_GUY, STAY, DOWN, MTMOONPOKECENTER_MOVE_DELETER
