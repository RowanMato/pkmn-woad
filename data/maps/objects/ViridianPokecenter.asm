	...
	const_export VIRIDIANPOKECENTER_MOVE_REMINDER
	const_export VIRIDIANPOKECENTER_MOVE_DELETER
...
ViridianPokecenter_Object:
	...
	object_event  6,  1, SPRITE_BIKE_SHOP_CLERK, STAY, DOWN, TEXT_VIRIDIANPOKECENTER_MOVE_REMINDER
	object_event  7,  1, SPRITE_BALDING_GUY, STAY, DOWN, TEXT_VIRIDIANPOKECENTER_MOVE_DELETER
