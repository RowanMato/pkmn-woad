	...
	const_export CINNABARPOKECENTER_MOVE_REMINDER
	const_export CINNABARPOKECENTER_MOVE_DELETER
...
CinnabarPokecenter_Object:
	...
	object_event  6,  1, SPRITE_BIKE_SHOP_CLERK, STAY, DOWN, CINNABARPOKECENTER_MOVE_REMINDER
	object_event  7,  1, SPRITE_BALDING_GUY, STAY, DOWN, CINNABARPOKECENTER_MOVE_DELETER
