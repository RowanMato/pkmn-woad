	...
	const_export ROCKTUNNELPOKECENTER_MOVE_REMINDER
	const_export ROCKTUNNELPOKECENTER_MOVE_DELETER
...
RockTunnelPokecenter_Object:
	...
	object_event  6,  1, SPRITE_BIKE_SHOP_CLERK, STAY, DOWN, ROCKTUNNELPOKECENTER_MOVE_REMINDER
	object_event  7,  1, SPRITE_BALDING_GUY, STAY, DOWN, ROCKTUNNELPOKECENTER_MOVE_DELETER
