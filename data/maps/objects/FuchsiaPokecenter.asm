	...
	const_export FUCHSIAPOKECENTER_MOVE_REMINDER
	const_export FUCHSIAPOKECENTER_MOVE_DELETER
...
FuchsiaPokecenter_Object:
	...
	object_event  6,  1, SPRITE_BIKE_SHOP_CLERK, STAY, DOWN, FUCHSIAPOKECENTER_MOVE_REMINDER
	object_event  7,  1, SPRITE_BALDING_GUY, STAY, DOWN, FUCHSIAPOKECENTER_MOVE_DELETER
