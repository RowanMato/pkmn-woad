	...
	const_export SAFFRONPOKECENTER_MOVE_REMINDER
	const_export SAFFRONPOKECENTER_MOVE_DELETER
...
SaffronPokecenter_Object:
	...
	object_event  6,  1, SPRITE_BIKE_SHOP_CLERK, STAY, DOWN, TEXT_SAFFRONPOKECENTER_MOVE_REMINDER
	object_event  7,  1, SPRITE_BALDING_GUY, STAY, DOWN, TEXT_SAFFRONPOKECENTER_MOVE_DELETER
