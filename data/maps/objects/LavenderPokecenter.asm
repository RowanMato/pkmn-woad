	...
	const_export LAVENDERPOKECENTER_MOVE_REMINDER
	const_export LAVENDERPOKECENTER_MOVE_DELETER
...
LavenderPokecenter_Object:
	...
	object_event  6,  1, SPRITE_BIKE_SHOP_CLERK, STAY, DOWN, LAVENDERPOKECENTER_MOVE_REMINDER
	object_event  7,  1, SPRITE_BALDING_GUY, STAY, DOWN, LAVENDERPOKECENTER_MOVE_DELETER
