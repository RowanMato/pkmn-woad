...
;	const HS_UNUSED_MAP_F4_1               ; BA XXX sprite doesn't exist
	...
	const HS_CELADON_MART_3F_COUNTER       ; E4
	const HS_CELADON_MART_3F_GOOD_TMS      ; E5
	const HS_CELADON_MART_3F_BAD_TMS       ; E6
	const HS_CELADON_MART_3F_GBKID1        ; E7
	const HS_CELADON_MART_3F_GBKID2        ; E8
	const HS_CELADON_MART_3F_GBKID3        ; E9
	const HS_CELADON_MART_3F_BOY           ; EA
	const HS_GAME_CORNER_PRIZE_BALD        ; EB
	const HS_GAME_CORNER_PRIZE_GAMBLER     ; EC
	const HS_GAME_CORNER_PRIZE_BLOCKADE    ; ED
	const HS_GAME_CORNER_PRIZE_FOSSIL      ; EE
	const HS_CERULEAN_BADGE_HOUSE_MAN      ; EF
	const HS_CERULEAN_BADGE_HOUSE_TM_SHOP  ; F0
	const HS_MEW													 ; F1
